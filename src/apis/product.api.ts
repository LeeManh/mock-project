...
import type { Category, Banner, TopProduct, ListProductResponse, ProductListConfig } from 'types/product.type'
...
const fetchListTopSellProducts = () => http.get<SuccessResponse<TopProduct[]>>('list-sell-product')
