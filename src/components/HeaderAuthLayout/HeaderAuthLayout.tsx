...
import { Container, Header, HeaderTitle, LeftHeader, RightHeader } from './HeaderAuthLayout.styled'
      ...
      <Header as='header'>
        <LeftHeader>
          <Link to={routePaths.home} style={{ display: 'flex' }}>
            <LogoShopee fill={colors.orange} style={{ cursor: 'pointer', height: '4.2rem' }} />
          </Link>
